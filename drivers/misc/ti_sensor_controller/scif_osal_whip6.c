...
#include <zephyr/drivers/misc/ti_sensor_controller/scif_osal_whip6.h>
...
void osalEnableCtrlReadyInt(void) {
    irq_connect_dynamic(INT_AUX_SWEV0 - 16, INT_PRI_LEVEL1, readyHandler, NULL, 0);
    irq_enable(INT_AUX_SWEV0 - 16);
...
void scifOsalEnableTaskAlertInt(void) {
    ...
    irq_enable(INT_AUX_SWEV1 - 16);
    irq_connect_dynamic(INT_AUX_SWEV1 - 16, INT_PRI_LEVEL1, alertHandler, NULL, 0);
